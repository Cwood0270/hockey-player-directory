...
- **Full path on this machine:** `/Users/cwood/Library/CloudStorage/OneDrive-UtahValleyUniversity/FALL 2026/Server-Side Frameworks/hockey-player-directory`
...
|-------|----------------|-----------------|
| Where am I? | `pwd` (mac/linux) or `cd` (Windows) | `/Users/cwood/Library/CloudStorage/OneDrive-UtahValleyUniversity/FALL 2026/Server-Side Frameworks/hockey-player-directory` |
| List project files | `ls` or `dir` | I see `docs/` |
| Brief readable | Open `docs/requirements-brief.md` in the editor | Actors (hockey ops staff, tutorial participant, coding agent) and the four routes (`/`, `/players`, `/players/$playerId`, `/games`) still make sense |

## Blockers and notes

- No blockers. Node and npm already printed versions in Cursor’s integrated terminal.
- Project folder on disk is `hockey-player-directory` (not `hockey-ops-directory`).
